...
Dabei ging es nie ausschließlich um die Theorie, sondern um das Ausprobieren: Mit Timeboxing, Kreativmethoden und viel Teamarbeit wurden komplexe Fragestellungen in kurzer Zeit bearbeitet und erste Konzepte entwickelt.
Eine Rückmeldung aus der Gruppe brachte die Erfahrung auf den Punkt:
{% include quote.html
   text="Ich hätte nicht gedacht, dass man so viel in kürzester Zeit erarbeiten kann."
   author="Claus Klipker" %}
